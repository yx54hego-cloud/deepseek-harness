...
| `ctx.mobileAccess` | `core` | `mobile-access` | - | - | - | Owns pairing, authentication, encryption, and the narrow Session request allowlist for the Web bundle's phone connection. |
