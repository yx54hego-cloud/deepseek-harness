...
<a id="ctxmobileaccess--mobileaccess"></a>

### `ctx.mobileAccess` — `MobileAccess`

Authenticated WebSocket listener and its current pairing URL.

Source: [`packages/host/mobile-access/src/index.ts:115`](../../packages/host/mobile-access/src/index.ts)
