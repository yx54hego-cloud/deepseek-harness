...
/** Directories whose packages this repository publishes: native stores, not npm, distribute apps/mobile. */
const releaseMemberDirectory = /^(?:packages\/[^/]+\/[^/]+|apps\/(?!mobile$)[^/]+|vendor\/[^/]+)$/
